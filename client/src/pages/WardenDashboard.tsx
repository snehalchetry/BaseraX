...
export default function WardenDashboard() {
    ...
    const quickActions = [
        { icon: 'directions_walk', label: 'Outing Requests', desc: 'Review and approve student outings', path: '/warden/outings', color: 'bg-teal-50 text-teal-600 border-teal-100', iconBg: 'bg-teal-600' },
        { icon: 'warning', label: 'Complaints', desc: 'Manage maintenance complaints', path: '/warden/complaints', color: 'bg-amber-50 text-amber-600 border-amber-100', iconBg: 'bg-amber-500' },
        { icon: 'restaurant', label: 'Food Menu', desc: 'View hostel mess menu', path: '/food-menu', color: 'bg-emerald-50 text-emerald-600 border-emerald-100', iconBg: 'bg-emerald-600' },
    ];
    ...
    return (
        <>
            <div className="mb-6 animate-fade-slide-in">
                ...
                <p className="text-sm text-gray-500 font-medium">Warden Dashboard — Manage hostel operations.</p>
            </div>
