...
export default function AdminDashboard() {
    ...
    const quickActions = [
        { icon: 'directions_walk', label: 'Outing Requests', desc: 'View all outing requests', path: '/admin/outings', color: 'bg-teal-50 text-teal-600 border-teal-100', iconBg: 'bg-teal-600' },
        { icon: 'warning', label: 'Complaints', desc: 'Manage all complaints', path: '/admin/complaints', color: 'bg-amber-50 text-amber-600 border-amber-100', iconBg: 'bg-amber-500' },
    ...
    return (
        <>
            <div className="mb-6 animate-fade-slide-in">
                ...
                <p className="text-sm text-gray-500 font-medium">Admin Dashboard — Full system control.</p>
            </div>
